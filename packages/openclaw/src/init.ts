    ...
    : {
        ...
        configSchema: {
          ...
          properties: {
            ...
            recallQueryMode: { type: 'string', enum: ['latest-user', 'prompt-plus-context'] },
            clientTimeoutMs: { type: 'number', minimum: 1000, maximum: 300000 },
            captureDebounceMs: { type: 'number', minimum: 0, maximum: 120000 },
            captureMaxInFlight: { type: 'number', minimum: 1, maximum: 10 },
